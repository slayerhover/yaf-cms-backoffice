...
class Smarty_Adapter implements Yaf_View_Interface {
	...
	public function __construct($tplPath = null, $extraParams = array()) {
		...
		$this->_smarty->registered_plugins['function']['url'] = array(array($this, '_func_url'), null, null, false, true);
	}
	
	 /**
     * 提供对 smarty:yaf url() 函数的支持
     */
    function _func_url($params)
    {
        $controllerName = isset($params['c']) ? $params['c'] : 'index';
        unset($params['c']);
        $actionName = isset($params['a']) ? $params['a'] : 'index';
        unset($params['a']);
        $args = array();
